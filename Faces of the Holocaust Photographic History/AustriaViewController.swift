...
class AustriaViewController: UIViewController {
    ...
    func loadPlist()->[[String:String]]{
        let path = Bundle.main.path(forResource: "AustriaProperty List", ofType: "plist")
...
extension AustriaViewController:UITableViewDataSource, UITableViewDelegate{
