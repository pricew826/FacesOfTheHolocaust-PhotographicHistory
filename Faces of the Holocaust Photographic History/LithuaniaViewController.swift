...
class LithuaniaViewController: UIViewController {
    ...
    func loadPlist()->[[String:String]]{
        let path = Bundle.main.path(forResource: "LithuaniaProperty List", ofType: "plist")
...
extension LithuaniaViewController:UITableViewDataSource, UITableViewDelegate{
