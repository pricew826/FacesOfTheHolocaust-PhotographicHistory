...
class RomaniaViewController: UIViewController {
    ...
    func loadPlist()->[[String:String]]{
        let path = Bundle.main.path(forResource: "RomaniaProperty List", ofType: "plist")
...
extension RomaniaViewController:UITableViewDataSource, UITableViewDelegate{
